    ...
    <section id="hero" class="w-full pb-24">
      <BaseSection>
        <div class="col-span-12 lg:col-span-6 mt-12 xl:mt-10 space-y-4 sm:space-y-6 px-6 text-center sm:text-left">
          ...
          >
            The World's <span class="text-header-gradient">Fastest Growing</span> Crypto real estate Web App
          </h1>
          <p data-aos="fade-down" data-aos-once="true" data-aos-delay="300" class="paragraph hidden sm:block">
            Buy and sell 200+ property shares world wide with crypto and credit/debit card.
          </p>
          <div
            data-aos="fade-up"
            data-aos-once="true"
...
<!--             <img
              ...
              alt=""
            /> -->
            <lottie :width="512" :height="512" :options="lottieOptions" v-on:animCreated="handleAnimation" />
          </div>
        </div>
        <img
          data-aos="fade-up"
    ...
    <section class="w-full my-24">
      <BaseSection>
        ...
        <div data-aos="fade-right" class="col-span-12 lg:col-span-6 mt-4 xl:mt-20 space-y-6 px-4">
          ...
          <p class="paragraph">
            Our DEX allows any investor to trade their property tokens
          </p>
    ...
    <section class="bg-partner relative max-w-full sm:mx-6 my-24 shadow sm:rounded-2xl overflow-hidden">
      <div class="w-full px-6 sm:px-0 py-16 flex flex-col items-center justify-center space-y-4 text-center">
        ...
        <div data-aos="fade-up" class="flex flex-wrap items-center justify-center">
          <LandingPartnerImage
            v-for="img in ['DFSA.png', 'clever.png', 'diamon-cutts.png', 'swiss-finance.png', 'gambio.png']"
            :key="img"
            :img="img"
          />
        </div>
      ...
      <BaseSection data-aos="fade-down">
        ...
        <div class="col-span-12 lg:col-span-5 space-y-6 px-4 sm:px-6 mt-20">
          <h2 class="text-4xl font-semibold">
            Introducing the <span class="text-header-gradient">houseFi</span> Credit Card
          </h2>
          ...
          <ul class="space-y-4 sm:space-y-2">
            ...
            <LandingListItem title="Earn rewards in bitcoin or any crypto on houseFi" />
          ...
          <ul class="space-y-8 sm:space-y-4">
            <LandingListItem title="Safety, security and compliance">
              <p class="text-sm text-gray-700 leading-relaxed">
                houseFi is a licensed New York trust company that undergoes regular bank exams and is subject to the
            ...
            <LandingListItem title="Hardware security keys">
              <p class="text-sm text-gray-700 leading-relaxed">
                With houseFi you can secure your account with a hardware security key via WebAuthn.
              </p>
            </LandingListItem>
            <LandingListItem title="SOC Certifications">
              <p class="text-sm text-gray-700 leading-relaxed">
                houseFi is <span class="underline">SOC 1 Type 2</span> and
...
export default {
  ...
  data() {
    return {
      ...
      accordions: [
        {
          title: 'Why should I choose houseFi?',
          description:
      ...
      steps: [
        {
          ...
          title: 'Sign Up',
          description:
            'Sign up for your free houseFi Wallet on web, iOS or Android and follow our easy process to set up your profile',
        },
        {
          img: 'fund.png',
          title: 'Fund',
          description:
            'Choose your preferred payment method such as bank transfer or credit card to top up your houseFi Wallet',
        },
        {
          img: 'buy-crypto.png',
          title: 'Buy Crypto',
